<x-modal name="create-activity" :show="$errors->hasBag('activityErrors')" focusable errorBag="activityErrors">
    <form method="post" action="{{ route('admin.activities.store') }}" class="p-6">
        ...
        <div>
            ...
            <x-input-error :messages="$errors->getBag('activityErrors')->get('nombre') class="mt-2" />
        </div>
        ...
        <div class="mt-4 flex w-full gap-2">
            <div class="w-1/2">
                ...
                <x-text-input id="fecha_inicio" class="block mt-1 w-full" type="date" name="fecha_inicio"
                    :value="old('fecha_inicio')" autofocus autocomplete="fecha_inicio" />
                <x-input-error :messages="$errors->getBag('activityErrors')->get('fecha_inicio')" class="mt-2" />
            </div>
            <div class="w-1/2">
                ...
                <x-input-error :messages="$errors->getBag('activityErrors')->get('fecha_fin')" class="mt-2" />
            </div>
        </div>
        ...
        <div class="mt-4 flex w-full gap-2">
            <div class="w-1/2">
                ...
                <x-input-error :messages="$errors->getBag('activityErrors')->get('estado')" class="mt-2" />
            </div>
            ...
            <div class="w-1/2">
                ...
                <x-input-error :messages="$errors->getBag('activityErrors')->get('manager_id')" class="mt-2" />
            </div>
        </div>
